<?php
    ...
    $sql="SELECT personal_details_mdb.user_id,personal_details_mdb.first_name,personal_details_mdb.middle_name,personal_details_mdb.last_name,academic_details.Branch,personal_details_mdb.phone_no,personal_details_mdb.email_id,academic_details.SSC_percent,academic_details.inter_percent,academic_details.b_tech_gpa,academic_details.YOP FROM personal_details_mdb , academic_details WHERE personal_details_mdb.user_id=academic_details.user_id";
    }
